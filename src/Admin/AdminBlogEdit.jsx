...
const AdminBlogEdit = () => {
  ...
  const fetchBlogDetails = async () => {
    ...
    const response = await fetch(`https://realestatebackend-1tat.onrender.com/admin/blog/from/${id}`, {
      method: "GET",
      headers: {
    ...
    setInputs(parseRes.data);
    setImageArr(parseRes.data);
    setLoading(true);
  };
  ...
  const handleEdit = async (e) => {
    ...
    const response = await fetch(
      `https://realestatebackend-1tat.onrender.com/admin/blog/update/${id}`,
      {
        method: "PUT",
        headers: {
          "Content-Type": "application/json",
      ...
      <form class="w-full max-w-lg">
        <div class="flex flex-wrap -mx-3 mb-6">
          ...
          {imageArr.blog_thumbnail !== undefined ? (
            <img src={imageArr.blog_thumbnail} />
          ) : (
            ""
          )}
          <div class="w-full  px-3">
        ...
        <button className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded mb-4" onClick={(e) => handleEdit(e)}>Submit</button>
