...
const AdminProductEdit = () => {
  ...
  const handleEdit = async (e) => {
    ...
    const response = await fetch(
      `https://realestatebackend-1tat.onrender.com/admin/product/update/${id}`,
      {
        method: "PUT",
        headers: {
    ...
    navigate(`/admin/main/product/success?q=2`);
  ...
  const fetchProductDetails = async () => {
    ...
    const id = searchParams.get("q");
    const response = await fetch(
      `https://realestatebackend-1tat.onrender.com/admin/product/from/${id}`,
      {
        method: "GET",
        headers: {
          "Content-Type": "application/json",
  ...
  return !loading ? (
    ...
    <div className="flex flex-col justify-center items-center">
      <form className="w-3/5">
        ...
        <button
          className="bg-navGreen hover:bg-yellow-700 text-white font-bold py-2 px-4 rounded mb-4"
