...
const TestimonialCard = ({name, position, desc}) => {
  return (
    <div>
                <div class="group w-full  bg-navBg relative flex flex-col items-center  cursor-pointer shadow-md md:p-12 p-6" style={{boxShadow: "7px 7px 10px #80808085"}}>
                    <div class="text-gray-600 dark:text-gray-200    flex flex-col items-center">
                        ...
                        <p class="xl:w-80 text-base leading-normal text-center mt-4">{desc}</p>
                    </div>
                    <div class="text-white dark:text-gray-800  absolute bottom-0 -mb-6">
                ...
                <div class="flex flex-col items-center justify-center mt-10">
                    ...
                    <p class="text-base font-semibold leading-4 my-2 text-gray-800 dark:text-black  ">{name}</p>
                    <p class="text-base leading-4 text-center text-gray-600 dark:text-gray-600 font-semibold">{position}</p>
                </div>
            </div>
  )
}
